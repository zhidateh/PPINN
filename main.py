...
setting_name        = "PPINN21"
node_filter         = 1
batch_1_ratio       = 1
case_size           = 10    
sampling_ratio      = 0.01  #1% x 16208 x 10 (1% of total dataset)
bc_ratio            = 0.1   #10% x 16208 x 10 (10% of BC)
batch_ratio         = 1     #100% x 1% x 16208 x 10 (100% of sample)
empty_batch         = 500     #50% x 100% x 1% x 16208 x 10 (50% of batch is empty)
num_epoch           = 50001
num_sampling        = 1
learning_rate       = 1e-3
wp                  = 0
...
load_chkpt_path     = 0     #'/home/zhida/Documents/PINN_CFD_2D_phase2/2d_inviscid_model/PINN5/PINN5-0'  ##use 0 to disable loading
...
model = pinn_2d.PINN_2D(P_back,x,y,P,rho,u,v,Et)
